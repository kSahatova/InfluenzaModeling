...
def set_parameters_range(incidence, a_detail=False):
    ...
    if incidence == "age-group":
        ...
        lam_range = (0.290, 0.292)  # (0.03, 0.24)
        a_range = (0.234, 0.236)
        ...
        exposed_range = {
            # 2010 
            "A(H1N1)pdm09": (0.82, 0.834),  # (0.54, 0.56),
            "A(H3N2)": (0.44,  0.459),   # (0.21, 0.22),
            "B": (0.115, 0.116) # (0.6, 0.62),
            # 2015
        ...
        lam_range = {
            ...
            # 2010
            "A(H1N1)pdm09": (0.13, 0.139), #  (0.189, 0.191),
            "A(H3N2)": (0.09, 0.1),  # (0.049, 0.051),
            "B": (0.07, 0.079)  # (0.196, 0.198)
            # 2015
        ...
        a_range = (0.23, 0.238) #  (0.0, 1.0)  # 2010 - (0.11, 0.13)
